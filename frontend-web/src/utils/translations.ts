...
export const translations: Translations = {
  fr: {
    ...
    invalidUsername: 'Nom d\'utilisateur invalide (min 4 caractères, alphanumérique)',
    invalidPassword: 'Mot de passe invalide (min 8 caractères, 1 majuscule, 1 chiffre)',
